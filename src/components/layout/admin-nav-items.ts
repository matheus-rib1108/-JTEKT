...
export const ADMIN_NAV: AdminNavGroup[] = [
  ...
  },
  {
    label: "Estoque",
    items: [
      { label: "Estoque", href: "/admin/estoque", permission: PERMISSIONS.INVENTORY_VIEW, phase: "Fase 2" },
      { label: "Produtos", href: "/admin/produtos", permission: PERMISSIONS.PRODUCTS_VIEW, phase: "Fase 2" },
      { label: "Categorias", href: "/admin/categorias", permission: PERMISSIONS.PRODUCTS_VIEW, phase: "Fase 2" },
  ...
  },
  {
    label: "Comercial",
    items: [
      { label: "Ofertas", href: "/admin/ofertas", permission: PERMISSIONS.OFFERS_VIEW, phase: "Fase 6" },
      { label: "Preços", href: "/admin/precos", permission: PERMISSIONS.PRICING_VIEW, phase: "Fase 6" },
      { label: "Pedidos", href: "/admin/pedidos", permission: PERMISSIONS.ORDERS_VIEW, phase: "Fase 7" },
